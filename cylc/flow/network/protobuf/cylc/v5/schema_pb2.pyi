...
class PbMeta(_message.Message):
    __slots__ = ("title", "description", "URL", "new_field")
    ...
    URL: str
    new_field: str
    def __init__(self, title: _Optional[str] = ..., description: _Optional[str] = ..., URL: _Optional[str] = ..., new_field: _Optional[str] = ...) -> None: ...
