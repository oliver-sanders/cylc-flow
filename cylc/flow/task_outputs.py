...
class TaskOutputs:
    ...
    def __init__(self, tdef):
        ...
        if (
            # "submitted" is not declared as optional or required
            tdef.outputs[TASK_OUTPUT_SUBMITTED][1] is None
            # and "submit-failed" is not declared as optional
            and tdef.outputs[TASK_OUTPUT_SUBMIT_FAILED][1] is not True
        ):
            self._add(
                TASK_OUTPUT_SUBMITTED,
                TASK_OUTPUT_SUBMITTED,
